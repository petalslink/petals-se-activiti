 ...
 */
package org.ow2.petals.activitibpmn.monitoring.defect;
...
public class AsyncExecutorThreadPoolDefectCreator implements JmxDefectCreator {
    ...
    public AsyncExecutorThreadPoolDefectCreator(final Monitoring monitoringMbean) {
    ...
    public MBeanNotificationInfo getNotificationInfo() {
        return new MBeanNotificationInfo(new String[] { DEFECT_NAME },
                AsyncExecutorThreadPoolDefectCreator.class.getName(), DEFECT_MSG);
    }
