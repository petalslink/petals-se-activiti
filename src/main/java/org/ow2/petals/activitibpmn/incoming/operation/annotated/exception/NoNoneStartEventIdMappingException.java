 ...
 * 
 */
public class NoNoneStartEventIdMappingException extends InvalidAnnotationForOperationException {

    private static final long serialVersionUID = 1229263822984773374L;

    private static final String MESSAGE = "The annotation defining the none start event identifier is required";

    public NoNoneStartEventIdMappingException(final QName wsdlOperation) {
